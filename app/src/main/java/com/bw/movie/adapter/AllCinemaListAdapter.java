...
public class AllCinemaListAdapter extends RecyclerView.Adapter<AllCinemaListAdapter.MyHolder>{

    private Context context;
    private List<AllCinemaBean.ResultBean> listBeans;

    public AllCinemaListAdapter(Context context, List<AllCinemaBean.ResultBean> listBeans) {
