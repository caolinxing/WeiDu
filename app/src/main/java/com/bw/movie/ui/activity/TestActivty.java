...
public class TestActivty extends AppCompatActivity implements MovieInfo_Contract.View, PingLun_Contract.View, SendMoviePingLun_Contract.View {
    ...
    public void showUpDownView() {
        ...
        params.height = Utils.dp2Px(TestActivty.this, Constant.POI_DEFAULT_SHOW_HEIGHT_BOTTOM);
    ...
    public void Success(Result_pinglunBean result_pinglunBean) {
        ToastUtils.showToast(TestActivty.this, result_pinglunBean.getMessage());
        adapter.notifyItemChanged(MutilEnty_MoviewInfo_Bean.TYPE_SIX);
    }
        ...
        adapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                if (view.getId() == R.id.movie_info_btn_share) {
                    ToastUtils.showToast(TestActivty.this, "点击了share");
                } else if (view.getId() == R.id.movie_info_btn_guanzhu) {
                    if (sp.getAll().isEmpty()) {
                        ToastUtils.showToast(TestActivty.this, "你还没登入呢！赶紧登入吧");
                    } else {
                    ...
                    if (sp.getAll().isEmpty()) {
                        ToastUtils.showToast(TestActivty.this, "请登入后点赞");
                    } else {
                        userId = sp.getInt("userId", 0);
                        sessionId = sp.getString("sessionId", "");
                        Log.i("TAGxxxx", "onItemChildClick: " + userId + sessionId);
    ...
    private void initView() {
        ...
        mMovieInfoRecycler.setLayoutManager(new LinearLayoutManager(this));
    }
}
